...
impl LifecycleExpirationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a LifecycleExpiration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		DateWriter::write_params(request, &obj.date, Some(&ArgumentLocation::Body), &"Date".to_string());
		DaysWriter::write_params(request, &obj.days, Some(&ArgumentLocation::Body), &"Days".to_string());
	}
}
#[derive(Debug, Default)]
...
impl PutBucketNotificationRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketNotificationRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		NotificationConfigurationDeprecatedWriter::write_params(request, &obj.notification_configuration, Some(&ArgumentLocation::Body), &"NotificationConfiguration".to_string());
...
impl PutBucketVersioningRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketVersioningRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		...
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
		VersioningConfigurationWriter::write_params(request, &obj.versioning_configuration, Some(&ArgumentLocation::Body), &"VersioningConfiguration".to_string());
	}
}
...
impl CopySourceVersionIdWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CopySourceVersionId, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl TopicConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a TopicConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for filter
		if let Some(ref obj) = obj.filter {
			NotificationConfigurationFilterWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Filter".to_string());
		}
		// optional writing for id
		if let Some(ref obj) = obj.id {
			NotificationIdWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Id".to_string());
		}
		TopicArnWriter::write_params(request, &obj.topic_arn, Some(&ArgumentLocation::Body), &"Topic".to_string());
		EventListWriter::write_params(request, &obj.events, Some(&ArgumentLocation::Body), &"Event".to_string());
	}
}
#[derive(Debug, Default)]
...
impl DestinationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Destination, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Body), &"Bucket".to_string());
		// optional writing for storage_class
		if let Some(ref obj) = obj.storage_class {
			StorageClassWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"StorageClass".to_string());
		}
	}
}
...
impl IfNoneMatchWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a IfNoneMatch, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl NoSuchBucketWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NoSuchBucket, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
	}
}
...
impl ObjectVersionStorageClassWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ObjectVersionStorageClass, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl MultipartUploadIdWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MultipartUploadId, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
struct RoleWriter;
impl RoleWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Role, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl WebsiteRedirectLocationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a WebsiteRedirectLocation, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl BucketVersioningStatusWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a BucketVersioningStatus, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl PutBucketReplicationRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketReplicationRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		ReplicationConfigurationWriter::write_params(request, &obj.replication_configuration, Some(&ArgumentLocation::Body), &"ReplicationConfiguration".to_string());
		// optional writing for content_md5
		if let Some(ref obj) = obj.content_md5 {
			ContentMD5Writer::write_params(request, &obj, Some(&ArgumentLocation::Header), &"Content-MD5".to_string());
		}
...
impl GetObjectTorrentRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetObjectTorrentRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
...
impl GetBucketReplicationRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketReplicationRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl NoncurrentVersionTransitionWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NoncurrentVersionTransition, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		DaysWriter::write_params(request, &obj.noncurrent_days, Some(&ArgumentLocation::Body), &"NoncurrentDays".to_string());
		TransitionStorageClassWriter::write_params(request, &obj.storage_class, Some(&ArgumentLocation::Body), &"StorageClass".to_string());
	}
}
#[derive(Debug, Default)]
...
impl LifecycleRulesWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a LifecycleRules, location: Option<&ArgumentLocation>, location_name: &str) {
...
struct BodyWriter;
impl BodyWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Body, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is blob
...
impl ReplicationConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ReplicationConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		ReplicationRulesWriter::write_params(request, &obj.rules, Some(&ArgumentLocation::Body), &"ReplicationRule".to_string());
		RoleWriter::write_params(request, &obj.role, Some(&ArgumentLocation::Body), &"Role".to_string());
	}
}
...
impl RequestPayerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a RequestPayer, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl GetBucketWebsiteRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketWebsiteRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
struct RulesWriter;
impl RulesWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Rules, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl CompleteMultipartUploadRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CompleteMultipartUploadRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for multipart_upload
		if let Some(ref obj) = obj.multipart_upload {
			CompletedMultipartUploadWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"CompleteMultipartUpload".to_string());
		}
...
impl DeleteMarkerEntryWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteMarkerEntry, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		OwnerWriter::write_params(request, &obj.owner, Some(&ArgumentLocation::Body), &"Owner".to_string());
		IsLatestWriter::write_params(request, &obj.is_latest, Some(&ArgumentLocation::Body), &"IsLatest".to_string());
		ObjectVersionIdWriter::write_params(request, &obj.version_id, Some(&ArgumentLocation::Body), &"VersionId".to_string());
		ObjectKeyWriter::write_params(request, &obj.key, Some(&ArgumentLocation::Body), &"Key".to_string());
		LastModifiedWriter::write_params(request, &obj.last_modified, Some(&ArgumentLocation::Body), &"LastModified".to_string());
	}
}
...
impl TargetBucketWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a TargetBucket, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl MFADeleteStatusWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MFADeleteStatus, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl MaxKeysWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MaxKeys, location: Option<&ArgumentLocation>, location_name: &str) {
...
struct PartWriter;
impl PartWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Part, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		LastModifiedWriter::write_params(request, &obj.last_modified, Some(&ArgumentLocation::Body), &"LastModified".to_string());
		PartNumberWriter::write_params(request, &obj.part_number, Some(&ArgumentLocation::Body), &"PartNumber".to_string());
		ETagWriter::write_params(request, &obj.e_tag, Some(&ArgumentLocation::Body), &"ETag".to_string());
		SizeWriter::write_params(request, &obj.size, Some(&ArgumentLocation::Body), &"Size".to_string());
	}
}
...
impl TargetGrantsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a TargetGrants, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl ListMultipartUploadsRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ListMultipartUploadsRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
...
impl GetBucketPolicyRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketPolicyRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl CloudFunctionWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CloudFunction, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl DeleteBucketWebsiteRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteBucketWebsiteRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl VersioningConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a VersioningConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketVersioningStatusWriter::write_params(request, &obj.status, Some(&ArgumentLocation::Body), &"Status".to_string());
		MFADeleteWriter::write_params(request, &obj.mfa_delete, Some(&ArgumentLocation::Body), &"MfaDelete".to_string());
	}
}
#[derive(Debug, Default)]
...
impl GetBucketCorsRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketCorsRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl IndexDocumentWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a IndexDocument, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		SuffixWriter::write_params(request, &obj.suffix, Some(&ArgumentLocation::Body), &"Suffix".to_string());
	}
}
...
impl TopicConfigurationListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a TopicConfigurationList, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl ReplaceKeyPrefixWithWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ReplaceKeyPrefixWith, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl CreateMultipartUploadRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CreateMultipartUploadRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for request_payer
		if let Some(ref obj) = obj.request_payer {
			RequestPayerWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-request-payer".to_string());
...
impl PutBucketCorsRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketCorsRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for content_md5
		if let Some(ref obj) = obj.content_md5 {
			ContentMD5Writer::write_params(request, &obj, Some(&ArgumentLocation::Header), &"Content-MD5".to_string());
		...
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
		CORSConfigurationWriter::write_params(request, &obj.cors_configuration, Some(&ArgumentLocation::Body), &"CORSConfiguration".to_string());
	}
}
...
impl CopySourceSSECustomerAlgorithmWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CopySourceSSECustomerAlgorithm, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
struct DaysWriter;
impl DaysWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Days, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is integer
		match location{
			None => (), // noop
			Some(loc) => {
...
struct ValueWriter;
impl ValueWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Value, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl DeletedObjectsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeletedObjects, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl DeleteBucketLifecycleRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteBucketLifecycleRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
struct TagWriter;
impl TagWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Tag, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		ValueWriter::write_params(request, &obj.value, Some(&ArgumentLocation::Body), &"Value".to_string());
		ObjectKeyWriter::write_params(request, &obj.key, Some(&ArgumentLocation::Body), &"Key".to_string());
	}
}
...
impl KeyMarkerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a KeyMarker, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl DeleteMarkersWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteMarkers, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl PutBucketPolicyRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketPolicyRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		PolicyWriter::write_params(request, &obj.policy, Some(&ArgumentLocation::Body), &"Policy".to_string());
		// optional writing for content_md5
		if let Some(ref obj) = obj.content_md5 {
			ContentMD5Writer::write_params(request, &obj, Some(&ArgumentLocation::Header), &"Content-MD5".to_string());
		}
...
impl ResponseContentDispositionWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ResponseContentDisposition, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl BucketLifecycleConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a BucketLifecycleConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		LifecycleRulesWriter::write_params(request, &obj.rules, Some(&ArgumentLocation::Body), &"LifecycleRule".to_string());
	}
}
...
impl GrantFullControlWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GrantFullControl, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl GetObjectAclRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetObjectAclRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
...
struct PartsWriter;
impl PartsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Parts, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl CommonPrefixListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CommonPrefixList, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl ProtocolWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Protocol, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
struct SuffixWriter;
impl SuffixWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Suffix, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl AllowedMethodWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a AllowedMethod, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl QueueConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a QueueConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for filter
		if let Some(ref obj) = obj.filter {
			NotificationConfigurationFilterWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Filter".to_string());
		...
		QueueArnWriter::write_params(request, &obj.queue_arn, Some(&ArgumentLocation::Body), &"Queue".to_string());
		EventListWriter::write_params(request, &obj.events, Some(&ArgumentLocation::Body), &"Event".to_string());
	}
}
...
impl BucketCannedACLWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a BucketCannedACL, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl SSECustomerKeyWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a SSECustomerKey, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ResponseCacheControlWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ResponseCacheControl, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl FilterRuleNameWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a FilterRuleName, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl HeadBucketRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a HeadBucketRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl AbortMultipartUploadRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a AbortMultipartUploadRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		MultipartUploadIdWriter::write_params(request, &obj.upload_id, Some(&ArgumentLocation::Querystring), &"uploadId".to_string());
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
		// optional writing for request_payer
...
struct SizeWriter;
impl SizeWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Size, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is integer
		match location{
			None => (), // noop
			Some(loc) => {
...
impl RedirectWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Redirect, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		ReplaceKeyWithWriter::write_params(request, &obj.replace_key_with, Some(&ArgumentLocation::Body), &"ReplaceKeyWith".to_string());
		HostNameWriter::write_params(request, &obj.host_name, Some(&ArgumentLocation::Body), &"HostName".to_string());
		ProtocolWriter::write_params(request, &obj.protocol, Some(&ArgumentLocation::Body), &"Protocol".to_string());
		ReplaceKeyPrefixWithWriter::write_params(request, &obj.replace_key_prefix_with, Some(&ArgumentLocation::Body), &"ReplaceKeyPrefixWith".to_string());
		HttpRedirectCodeWriter::write_params(request, &obj.http_redirect_code, Some(&ArgumentLocation::Body), &"HttpRedirectCode".to_string());
	}
}
...
impl CopySourceIfNoneMatchWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CopySourceIfNoneMatch, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl DeleteBucketCorsRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteBucketCorsRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl BucketAlreadyExistsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a BucketAlreadyExists, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
	}
}
...
impl BucketLocationConstraintWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a BucketLocationConstraint, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl GetBucketNotificationConfigurationRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketNotificationConfigurationRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl NextKeyMarkerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NextKeyMarker, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl AllowedMethodsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a AllowedMethods, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl VersionIdMarkerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a VersionIdMarker, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl StorageClassWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a StorageClass, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl CreateBucketConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CreateBucketConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketLocationConstraintWriter::write_params(request, &obj.location_constraint, Some(&ArgumentLocation::Body), &"LocationConstraint".to_string());
	}
}
...
impl BucketLogsPermissionWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a BucketLogsPermission, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl HeadObjectRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a HeadObjectRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for sse_customer_algorithm
		if let Some(ref obj) = obj.sse_customer_algorithm {
			SSECustomerAlgorithmWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-server-side-encryption-customer-algorithm".to_string());
...
impl DisplayNameWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DisplayName, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl GrantReadACPWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GrantReadACP, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
struct GrantWriter;
impl GrantWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Grant, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		GranteeWriter::write_params(request, &obj.grantee, Some(&ArgumentLocation::Body), &"Grantee".to_string());
		PermissionWriter::write_params(request, &obj.permission, Some(&ArgumentLocation::Body), &"Permission".to_string());
	}
}
#[derive(Debug, Default)]
...
impl TopicConfigurationDeprecatedWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a TopicConfigurationDeprecated, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		TopicArnWriter::write_params(request, &obj.topic, Some(&ArgumentLocation::Body), &"Topic".to_string());
		NotificationIdWriter::write_params(request, &obj.id, Some(&ArgumentLocation::Body), &"Id".to_string());
		EventWriter::write_params(request, &obj.event, Some(&ArgumentLocation::Body), &"Event".to_string());
		EventListWriter::write_params(request, &obj.events, Some(&ArgumentLocation::Body), &"Event".to_string());
	}
}
...
impl CopySourceIfModifiedSinceWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CopySourceIfModifiedSince, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl InitiatorWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Initiator, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		DisplayNameWriter::write_params(request, &obj.display_name, Some(&ArgumentLocation::Body), &"DisplayName".to_string());
		IDWriter::write_params(request, &obj.id, Some(&ArgumentLocation::Body), &"ID".to_string());
	}
}
...
impl HttpRedirectCodeWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a HttpRedirectCode, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ListObjectVersionsRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ListObjectVersionsRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
		// optional writing for prefix
		if let Some(ref obj) = obj.prefix {
...
impl DeleteBucketRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteBucketRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl TargetPrefixWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a TargetPrefix, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl DeleteBucketPolicyRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteBucketPolicyRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl CloudFunctionInvocationRoleWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CloudFunctionInvocationRole, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl DeleteBucketReplicationRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteBucketReplicationRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl PartNumberWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PartNumber, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is integer
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ExposeHeadersWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ExposeHeaders, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl ListObjectsRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ListObjectsRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
		// optional writing for prefix
		if let Some(ref obj) = obj.prefix {
...
struct PolicyWriter;
impl PolicyWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Policy, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl IfUnmodifiedSinceWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a IfUnmodifiedSince, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is timestamp
		match location{
			None => (), // noop
			Some(loc) => {
...
impl PermissionWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Permission, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl MetadataWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Metadata, location: Option<&ArgumentLocation>, location_name: &str) {
...
struct GrantsWriter;
impl GrantsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Grants, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl ObjectStorageClassWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ObjectStorageClass, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl EventListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a EventList, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl EmailAddressWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a EmailAddress, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl PutBucketWebsiteRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketWebsiteRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for content_md5
		if let Some(ref obj) = obj.content_md5 {
			ContentMD5Writer::write_params(request, &obj, Some(&ArgumentLocation::Header), &"Content-MD5".to_string());
		...
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
		WebsiteConfigurationWriter::write_params(request, &obj.website_configuration, Some(&ArgumentLocation::Body), &"WebsiteConfiguration".to_string());
	}
}
...
impl IsTruncatedWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a IsTruncated, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl CreateBucketRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CreateBucketRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for grant_full_control
		if let Some(ref obj) = obj.grant_full_control {
			GrantFullControlWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-grant-full-control".to_string());
		...
		if let Some(ref obj) = obj.create_bucket_configuration {
			CreateBucketConfigurationWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"CreateBucketConfiguration".to_string());
		}
		// optional writing for grant_write_acp
		if let Some(ref obj) = obj.grant_write_acp {
			GrantWriteACPWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-grant-write-acp".to_string());
...
impl BucketNameWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a BucketName, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl TargetGrantWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a TargetGrant, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		GranteeWriter::write_params(request, &obj.grantee, Some(&ArgumentLocation::Body), &"Grantee".to_string());
		BucketLogsPermissionWriter::write_params(request, &obj.permission, Some(&ArgumentLocation::Body), &"Permission".to_string());
	}
}
...
impl FilterRuleValueWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a FilterRuleValue, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl PutBucketRequestPaymentRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketRequestPaymentRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		RequestPaymentConfigurationWriter::write_params(request, &obj.request_payment_configuration, Some(&ArgumentLocation::Body), &"RequestPaymentConfiguration".to_string());
		// optional writing for content_md5
		if let Some(ref obj) = obj.content_md5 {
			ContentMD5Writer::write_params(request, &obj, Some(&ArgumentLocation::Header), &"Content-MD5".to_string());
		}
...
impl PutObjectAclRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutObjectAclRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for grant_full_control
		if let Some(ref obj) = obj.grant_full_control {
			GrantFullControlWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-grant-full-control".to_string());
		...
		if let Some(ref obj) = obj.access_control_policy {
			AccessControlPolicyWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"AccessControlPolicy".to_string());
		}
		// optional writing for grant_write
		if let Some(ref obj) = obj.grant_write {
			GrantWriteWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-grant-write".to_string());
...
impl CloudFunctionConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CloudFunctionConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		CloudFunctionInvocationRoleWriter::write_params(request, &obj.invocation_role, Some(&ArgumentLocation::Body), &"InvocationRole".to_string());
		CloudFunctionWriter::write_params(request, &obj.cloud_function, Some(&ArgumentLocation::Body), &"CloudFunction".to_string());
		EventListWriter::write_params(request, &obj.events, Some(&ArgumentLocation::Body), &"Event".to_string());
		NotificationIdWriter::write_params(request, &obj.id, Some(&ArgumentLocation::Body), &"Id".to_string());
		EventWriter::write_params(request, &obj.event, Some(&ArgumentLocation::Body), &"Event".to_string());
	}
...
impl LambdaFunctionArnWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a LambdaFunctionArn, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl NotificationConfigurationFilterWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NotificationConfigurationFilter, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		S3KeyFilterWriter::write_params(request, &obj.key, Some(&ArgumentLocation::Body), &"S3Key".to_string());
	}
}
pub type Quiet = bool;
...
struct QuietWriter;
impl QuietWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Quiet, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is boolean
		match location{
			None => (), // noop
			Some(loc) => {
...
impl AccessControlPolicyWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a AccessControlPolicy, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		OwnerWriter::write_params(request, &obj.owner, Some(&ArgumentLocation::Body), &"Owner".to_string());
		GrantsWriter::write_params(request, &obj.grants, Some(&ArgumentLocation::Body), &"Grant".to_string());
	}
}
...
struct RangeWriter;
impl RangeWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Range, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl GrantReadWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GrantRead, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl SSECustomerKeyMD5Writer {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a SSECustomerKeyMD5, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ObjectIdentifierListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ObjectIdentifierList, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl RestoreWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Restore, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl NextVersionIdMarkerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NextVersionIdMarker, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
struct DeleteWriter;
impl DeleteWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Delete, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		ObjectIdentifierListWriter::write_params(request, &obj.objects, Some(&ArgumentLocation::Body), &"ObjectIdentifier".to_string());
		// optional writing for quiet
		if let Some(ref obj) = obj.quiet {
			QuietWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Quiet".to_string());
		}
	}
}
...
impl ResponseContentLanguageWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ResponseContentLanguage, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl GrantWriteACPWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GrantWriteACP, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl CORSRulesWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CORSRules, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl ContentLanguageWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ContentLanguage, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl DeleteObjectRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteObjectRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for mfa
		if let Some(ref obj) = obj.mfa {
			MFAWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-mfa".to_string());
...
impl CompletedPartListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CompletedPartList, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl DeletedObjectWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeletedObject, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		ObjectVersionIdWriter::write_params(request, &obj.version_id, Some(&ArgumentLocation::Body), &"VersionId".to_string());
		DeleteMarkerVersionIdWriter::write_params(request, &obj.delete_marker_version_id, Some(&ArgumentLocation::Body), &"DeleteMarkerVersionId".to_string());
		ObjectKeyWriter::write_params(request, &obj.key, Some(&ArgumentLocation::Body), &"Key".to_string());
		DeleteMarkerWriter::write_params(request, &obj.delete_marker, Some(&ArgumentLocation::Body), &"DeleteMarker".to_string());
	}
}
#[derive(Debug, Default)]
pub struct CORSRule {
...
impl CORSRuleWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CORSRule, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for allowed_headers
		if let Some(ref obj) = obj.allowed_headers {
			AllowedHeadersWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"AllowedHeader".to_string());
		}
		// optional writing for expose_headers
		if let Some(ref obj) = obj.expose_headers {
			ExposeHeadersWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"ExposeHeader".to_string());
		}
		AllowedMethodsWriter::write_params(request, &obj.allowed_methods, Some(&ArgumentLocation::Body), &"AllowedMethod".to_string());
		// optional writing for max_age_seconds
		if let Some(ref obj) = obj.max_age_seconds {
			MaxAgeSecondsWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"MaxAgeSeconds".to_string());
		}
		AllowedOriginsWriter::write_params(request, &obj.allowed_origins, Some(&ArgumentLocation::Body), &"AllowedOrigin".to_string());
	}
}
#[derive(Debug, Default)]
...
impl LoggingEnabledWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a LoggingEnabled, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		TargetPrefixWriter::write_params(request, &obj.target_prefix, Some(&ArgumentLocation::Body), &"TargetPrefix".to_string());
		TargetBucketWriter::write_params(request, &obj.target_bucket, Some(&ArgumentLocation::Body), &"TargetBucket".to_string());
		TargetGrantsWriter::write_params(request, &obj.target_grants, Some(&ArgumentLocation::Body), &"Grant".to_string());
	}
}
...
impl KeyPrefixEqualsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a KeyPrefixEquals, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl RedirectAllRequestsToWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a RedirectAllRequestsTo, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		HostNameWriter::write_params(request, &obj.host_name, Some(&ArgumentLocation::Body), &"HostName".to_string());
		// optional writing for protocol
		if let Some(ref obj) = obj.protocol {
			ProtocolWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Protocol".to_string());
		}
	}
}
#[derive(Debug, Default)]
...
struct OwnerWriter;
impl OwnerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Owner, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		DisplayNameWriter::write_params(request, &obj.display_name, Some(&ArgumentLocation::Body), &"DisplayName".to_string());
		IDWriter::write_params(request, &obj.id, Some(&ArgumentLocation::Body), &"ID".to_string());
	}
...
impl S3ClientMessageWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a S3ClientMessage, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl LifecycleRuleWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a LifecycleRule, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		ExpirationStatusWriter::write_params(request, &obj.status, Some(&ArgumentLocation::Body), &"Status".to_string());
		// optional writing for noncurrent_version_expiration
		if let Some(ref obj) = obj.noncurrent_version_expiration {
			NoncurrentVersionExpirationWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"NoncurrentVersionExpiration".to_string());
		}
		// optional writing for noncurrent_version_transitions
		if let Some(ref obj) = obj.noncurrent_version_transitions {
			NoncurrentVersionTransitionListWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"NoncurrentVersionTransition".to_string());
		}
		PrefixWriter::write_params(request, &obj.prefix, Some(&ArgumentLocation::Body), &"Prefix".to_string());
		// optional writing for expiration
		if let Some(ref obj) = obj.expiration {
			LifecycleExpirationWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Expiration".to_string());
		}
		// optional writing for transitions
		if let Some(ref obj) = obj.transitions {
			TransitionListWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Transition".to_string());
		}
		// optional writing for id
		if let Some(ref obj) = obj.id {
			IDWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"ID".to_string());
		}
	}
}
#[derive(Debug, Default)]
...
struct EventWriter;
impl EventWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Event, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ReplicationRulesWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ReplicationRules, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl NotificationConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NotificationConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		QueueConfigurationListWriter::write_params(request, &obj.queue_configurations, Some(&ArgumentLocation::Body), &"QueueConfiguration".to_string());
		LambdaFunctionConfigurationListWriter::write_params(request, &obj.lambda_function_configurations, Some(&ArgumentLocation::Body), &"LambdaFunctionConfiguration".to_string());
		TopicConfigurationListWriter::write_params(request, &obj.topic_configurations, Some(&ArgumentLocation::Body), &"TopicConfiguration".to_string());
	}
}
...
impl NoncurrentVersionTransitionListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NoncurrentVersionTransitionList, location: Option<&ArgumentLocation>, location_name: &str) {
...
struct ObjectWriter;
impl ObjectWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Object, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		LastModifiedWriter::write_params(request, &obj.last_modified, Some(&ArgumentLocation::Body), &"LastModified".to_string());
		ETagWriter::write_params(request, &obj.e_tag, Some(&ArgumentLocation::Body), &"ETag".to_string());
		ObjectStorageClassWriter::write_params(request, &obj.storage_class, Some(&ArgumentLocation::Body), &"StorageClass".to_string());
		ObjectKeyWriter::write_params(request, &obj.key, Some(&ArgumentLocation::Body), &"Key".to_string());
		OwnerWriter::write_params(request, &obj.owner, Some(&ArgumentLocation::Body), &"Owner".to_string());
		SizeWriter::write_params(request, &obj.size, Some(&ArgumentLocation::Body), &"Size".to_string());
	}
...
impl TransitionListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a TransitionList, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl NextMarkerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NextMarker, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl MetadataDirectiveWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MetadataDirective, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ContentEncodingWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ContentEncoding, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl WebsiteConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a WebsiteConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		RedirectAllRequestsToWriter::write_params(request, &obj.redirect_all_requests_to, Some(&ArgumentLocation::Body), &"RedirectAllRequestsTo".to_string());
		IndexDocumentWriter::write_params(request, &obj.index_document, Some(&ArgumentLocation::Body), &"IndexDocument".to_string());
		ErrorDocumentWriter::write_params(request, &obj.error_document, Some(&ArgumentLocation::Body), &"ErrorDocument".to_string());
		RoutingRulesWriter::write_params(request, &obj.routing_rules, Some(&ArgumentLocation::Body), &"RoutingRule".to_string());
	}
}
...
impl MFADeleteWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MFADelete, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl CopySourceSSECustomerKeyWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CopySourceSSECustomerKey, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ResponseContentTypeWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ResponseContentType, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ExposeHeaderWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ExposeHeader, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl GetBucketAclRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketAclRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl HostNameWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a HostName, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl NextUploadIdMarkerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NextUploadIdMarker, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl AcceptRangesWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a AcceptRanges, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ObjectAlreadyInActiveTierErrorWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ObjectAlreadyInActiveTierError, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
	}
}
#[derive(Debug, Default)]
...
impl CompletedMultipartUploadWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CompletedMultipartUpload, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		CompletedPartListWriter::write_params(request, &obj.parts, Some(&ArgumentLocation::Body), &"CompletedPart".to_string());
	}
}
...
impl InitiatedWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Initiated, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is timestamp
		match location{
			None => (), // noop
			Some(loc) => {
...
impl PutBucketAclRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketAclRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for grant_full_control
		if let Some(ref obj) = obj.grant_full_control {
			GrantFullControlWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-grant-full-control".to_string());
...
impl CopySourceWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CopySource, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl QueueConfigurationListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a QueueConfigurationList, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl ObjectNotInActiveTierErrorWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ObjectNotInActiveTierError, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
	}
}
...
impl TransitionStorageClassWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a TransitionStorageClass, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl DeleteMarkerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteMarker, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is boolean
		match location{
			None => (), // noop
			Some(loc) => {
...
struct RuleWriter;
impl RuleWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Rule, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		ExpirationStatusWriter::write_params(request, &obj.status, Some(&ArgumentLocation::Body), &"Status".to_string());
		// optional writing for noncurrent_version_expiration
		if let Some(ref obj) = obj.noncurrent_version_expiration {
		...
		if let Some(ref obj) = obj.transition {
			TransitionWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Transition".to_string());
		}
		PrefixWriter::write_params(request, &obj.prefix, Some(&ArgumentLocation::Body), &"Prefix".to_string());
		// optional writing for expiration
		if let Some(ref obj) = obj.expiration {
		...
		if let Some(ref obj) = obj.noncurrent_version_transition {
			NoncurrentVersionTransitionWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"NoncurrentVersionTransition".to_string());
		}
		// optional writing for id
		if let Some(ref obj) = obj.id {
			IDWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"ID".to_string());
...
impl RoutingRulesWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a RoutingRules, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl ReplicationRuleWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ReplicationRule, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		ReplicationRuleStatusWriter::write_params(request, &obj.status, Some(&ArgumentLocation::Body), &"Status".to_string());
		PrefixWriter::write_params(request, &obj.prefix, Some(&ArgumentLocation::Body), &"Prefix".to_string());
		DestinationWriter::write_params(request, &obj.destination, Some(&ArgumentLocation::Body), &"Destination".to_string());
		// optional writing for id
		if let Some(ref obj) = obj.id {
			IDWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"ID".to_string());
		}
...
struct DateWriter;
impl DateWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Date, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is timestamp
		match location{
			None => (), // noop
			Some(loc) => {
...
impl CacheControlWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CacheControl, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl AllowedOriginWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a AllowedOrigin, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl IfModifiedSinceWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a IfModifiedSince, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is timestamp
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ConditionWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Condition, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		HttpErrorCodeReturnedEqualsWriter::write_params(request, &obj.http_error_code_returned_equals, Some(&ArgumentLocation::Body), &"HttpErrorCodeReturnedEquals".to_string());
		KeyPrefixEqualsWriter::write_params(request, &obj.key_prefix_equals, Some(&ArgumentLocation::Body), &"KeyPrefixEquals".to_string());
	}
}
#[derive(Debug, Default)]
...
impl ErrorDocumentWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ErrorDocument, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		ObjectKeyWriter::write_params(request, &obj.key, Some(&ArgumentLocation::Body), &"Key".to_string());
	}
}
...
impl FilterRuleWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a FilterRule, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		FilterRuleNameWriter::write_params(request, &obj.name, Some(&ArgumentLocation::Body), &"Name".to_string());
		FilterRuleValueWriter::write_params(request, &obj.value, Some(&ArgumentLocation::Body), &"Value".to_string());
	}
}
#[derive(Debug, Default)]
...
impl PutBucketLifecycleRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketLifecycleRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for lifecycle_configuration
		if let Some(ref obj) = obj.lifecycle_configuration {
			LifecycleConfigurationWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"LifecycleConfiguration".to_string());
		}
		// optional writing for content_md5
		if let Some(ref obj) = obj.content_md5 {
			ContentMD5Writer::write_params(request, &obj, Some(&ArgumentLocation::Header), &"Content-MD5".to_string());
...
impl ContentLengthWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ContentLength, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is integer
		match location{
			None => (), // noop
			Some(loc) => {
...
impl TransitionWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Transition, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		DateWriter::write_params(request, &obj.date, Some(&ArgumentLocation::Body), &"Date".to_string());
		DaysWriter::write_params(request, &obj.days, Some(&ArgumentLocation::Body), &"Days".to_string());
		TransitionStorageClassWriter::write_params(request, &obj.storage_class, Some(&ArgumentLocation::Body), &"StorageClass".to_string());
...
impl QueueConfigurationDeprecatedWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a QueueConfigurationDeprecated, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		QueueArnWriter::write_params(request, &obj.queue, Some(&ArgumentLocation::Body), &"Queue".to_string());
		EventListWriter::write_params(request, &obj.events, Some(&ArgumentLocation::Body), &"Event".to_string());
		NotificationIdWriter::write_params(request, &obj.id, Some(&ArgumentLocation::Body), &"Id".to_string());
		EventWriter::write_params(request, &obj.event, Some(&ArgumentLocation::Body), &"Event".to_string());
	}
...
impl GetBucketLifecycleRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketLifecycleRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl CopySourceSSECustomerKeyMD5Writer {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CopySourceSSECustomerKeyMD5, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl SSECustomerAlgorithmWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a SSECustomerAlgorithm, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl S3ClientErrorWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a S3ClientError, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		ObjectVersionIdWriter::write_params(request, &obj.version_id, Some(&ArgumentLocation::Body), &"VersionId".to_string());
		CodeWriter::write_params(request, &obj.code, Some(&ArgumentLocation::Body), &"Code".to_string());
		S3ClientMessageWriter::write_params(request, &obj.message, Some(&ArgumentLocation::Body), &"Message".to_string());
		ObjectKeyWriter::write_params(request, &obj.key, Some(&ArgumentLocation::Body), &"Key".to_string());
	}
}
#[derive(Debug, Default)]
...
impl BucketLoggingStatusWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a BucketLoggingStatus, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		LoggingEnabledWriter::write_params(request, &obj.logging_enabled, Some(&ArgumentLocation::Body), &"LoggingEnabled".to_string());
	}
}
...
impl IsLatestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a IsLatest, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is boolean
		match location{
			None => (), // noop
			Some(loc) => {
...
impl MaxUploadsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MaxUploads, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is integer
		match location{
			None => (), // noop
			Some(loc) => {
...
impl RoutingRuleWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a RoutingRule, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		RedirectWriter::write_params(request, &obj.redirect, Some(&ArgumentLocation::Body), &"Redirect".to_string());
		// optional writing for condition
		if let Some(ref obj) = obj.condition {
			ConditionWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Condition".to_string());
		}
	}
}
...
impl MissingMetaWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MissingMeta, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is integer
		match location{
			None => (), // noop
			Some(loc) => {
...
impl SSEKMSKeyIdWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a SSEKMSKeyId, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl AllowedOriginsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a AllowedOrigins, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl NoSuchUploadWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NoSuchUpload, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
	}
}
#[derive(Debug)]
...
impl PutObjectRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutObjectRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for request_payer
		if let Some(ref obj) = obj.request_payer {
			RequestPayerWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-request-payer".to_string());
		...
		if let Some(ref obj) = obj.body {
			BodyWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Body".to_string());
		}
		// optional writing for sse_customer_key
		if let Some(ref obj) = obj.sse_customer_key {
			SSECustomerKeyWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-server-side-encryption-customer-key".to_string());
...
struct CodeWriter;
impl CodeWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Code, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ReplicationStatusWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ReplicationStatus, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl AllowedHeadersWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a AllowedHeaders, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl TaggingWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Tagging, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		TagSetWriter::write_params(request, &obj.tag_set, Some(&ArgumentLocation::Body), &"Tag".to_string());
	}
}
...
impl ContentMD5Writer {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ContentMD5, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ObjectVersionWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ObjectVersion, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		LastModifiedWriter::write_params(request, &obj.last_modified, Some(&ArgumentLocation::Body), &"LastModified".to_string());
		ObjectVersionIdWriter::write_params(request, &obj.version_id, Some(&ArgumentLocation::Body), &"VersionId".to_string());
		ETagWriter::write_params(request, &obj.e_tag, Some(&ArgumentLocation::Body), &"ETag".to_string());
		ObjectVersionStorageClassWriter::write_params(request, &obj.storage_class, Some(&ArgumentLocation::Body), &"StorageClass".to_string());
		ObjectKeyWriter::write_params(request, &obj.key, Some(&ArgumentLocation::Body), &"Key".to_string());
		OwnerWriter::write_params(request, &obj.owner, Some(&ArgumentLocation::Body), &"Owner".to_string());
		IsLatestWriter::write_params(request, &obj.is_latest, Some(&ArgumentLocation::Body), &"IsLatest".to_string());
		SizeWriter::write_params(request, &obj.size, Some(&ArgumentLocation::Body), &"Size".to_string());
...
impl PutBucketNotificationConfigurationRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketNotificationConfigurationRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		NotificationConfigurationWriter::write_params(request, &obj.notification_configuration, Some(&ArgumentLocation::Body), &"NotificationConfiguration".to_string());
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
struct PrefixWriter;
impl PrefixWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Prefix, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ObjectListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ObjectList, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl CopyObjectRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CopyObjectRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for request_payer
		if let Some(ref obj) = obj.request_payer {
			RequestPayerWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-request-payer".to_string());
...
impl DeleteObjectsRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteObjectsRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for mfa
		if let Some(ref obj) = obj.mfa {
			MFAWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-mfa".to_string());
		...
		DeleteWriter::write_params(request, &obj.delete, Some(&ArgumentLocation::Body), &"Delete".to_string());
	}
}
#[derive(Debug, Default)]
...
struct MarkerWriter;
impl MarkerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Marker, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ObjectCannedACLWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ObjectCannedACL, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl RestoreRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a RestoreRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		DaysWriter::write_params(request, &obj.days, Some(&ArgumentLocation::Body), &"Days".to_string());
	}
}
...
impl CompletedPartWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CompletedPart, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		PartNumberWriter::write_params(request, &obj.part_number, Some(&ArgumentLocation::Body), &"PartNumber".to_string());
		ETagWriter::write_params(request, &obj.e_tag, Some(&ArgumentLocation::Body), &"ETag".to_string());
	}
...
impl QueueArnWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a QueueArn, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl LocationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Location, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl HttpErrorCodeReturnedEqualsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a HttpErrorCodeReturnedEquals, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl NotificationConfigurationDeprecatedWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NotificationConfigurationDeprecated, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		CloudFunctionConfigurationWriter::write_params(request, &obj.cloud_function_configuration, Some(&ArgumentLocation::Body), &"CloudFunctionConfiguration".to_string());
		QueueConfigurationDeprecatedWriter::write_params(request, &obj.queue_configuration, Some(&ArgumentLocation::Body), &"QueueConfiguration".to_string());
		TopicConfigurationDeprecatedWriter::write_params(request, &obj.topic_configuration, Some(&ArgumentLocation::Body), &"TopicConfiguration".to_string());
	}
}
#[derive(Debug, Default)]
...
impl UploadPartCopyRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a UploadPartCopyRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for copy_source_if_match
		if let Some(ref obj) = obj.copy_source_if_match {
			CopySourceIfMatchWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-copy-source-if-match".to_string());
...
impl CORSConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CORSConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		CORSRulesWriter::write_params(request, &obj.cors_rules, Some(&ArgumentLocation::Body), &"CORSRule".to_string());
	}
}
...
impl LastModifiedWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a LastModified, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is timestamp
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ContentRangeWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ContentRange, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl GranteeWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Grantee, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for email_address
		if let Some(ref obj) = obj.email_address {
			EmailAddressWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"EmailAddress".to_string());
		}
		TypeWriter::write_params(request, &obj.foo_type, Some(&ArgumentLocation::Body), &"xsi:type".to_string());
		// optional writing for display_name
		if let Some(ref obj) = obj.display_name {
			DisplayNameWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"DisplayName".to_string());
		}
		// optional writing for id
		if let Some(ref obj) = obj.id {
			IDWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"ID".to_string());
		...
		if let Some(ref obj) = obj.uri {
			URIWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"URI".to_string());
		}
	}
}
...
impl ExpirationStatusWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ExpirationStatus, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl CopySourceIfUnmodifiedSinceWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CopySourceIfUnmodifiedSince, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is timestamp
		match location{
			None => (), // noop
			Some(loc) => {
...
impl GetBucketVersioningRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketVersioningRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl MultipartUploadWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MultipartUpload, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		InitiatorWriter::write_params(request, &obj.initiator, Some(&ArgumentLocation::Body), &"Initiator".to_string());
		InitiatedWriter::write_params(request, &obj.initiated, Some(&ArgumentLocation::Body), &"Initiated".to_string());
		MultipartUploadIdWriter::write_params(request, &obj.upload_id, Some(&ArgumentLocation::Body), &"UploadId".to_string());
		StorageClassWriter::write_params(request, &obj.storage_class, Some(&ArgumentLocation::Body), &"StorageClass".to_string());
		ObjectKeyWriter::write_params(request, &obj.key, Some(&ArgumentLocation::Body), &"Key".to_string());
		OwnerWriter::write_params(request, &obj.owner, Some(&ArgumentLocation::Body), &"Owner".to_string());
	}
}
...
impl GrantWriteWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GrantWrite, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
struct TagSetWriter;
impl TagSetWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a TagSet, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl LambdaFunctionConfigurationListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a LambdaFunctionConfigurationList, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl ServerSideEncryptionWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ServerSideEncryption, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl NoncurrentVersionExpirationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NoncurrentVersionExpiration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		DaysWriter::write_params(request, &obj.noncurrent_days, Some(&ArgumentLocation::Body), &"NoncurrentDays".to_string());
	}
}
...
impl GetObjectRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetObjectRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
...
impl ContentDispositionWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ContentDisposition, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl MetadataKeyWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MetadataKey, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ResponseContentEncodingWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ResponseContentEncoding, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl GetBucketLoggingRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketLoggingRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl UploadIdMarkerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a UploadIdMarker, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
struct PayerWriter;
impl PayerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Payer, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
struct TypeWriter;
impl TypeWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Type, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl BucketsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Buckets, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl ExpiresWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Expires, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is timestamp
		match location{
			None => (), // noop
			Some(loc) => {
...
impl RestoreObjectRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a RestoreObjectRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for version_id
		if let Some(ref obj) = obj.version_id {
			ObjectVersionIdWriter::write_params(request, &obj, Some(&ArgumentLocation::Querystring), &"versionId".to_string());
		...
		if let Some(ref obj) = obj.restore_request {
			RestoreRequestWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"RestoreRequest".to_string());
		}
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
		// optional writing for request_payer
		if let Some(ref obj) = obj.request_payer {
...
impl ReplaceKeyWithWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ReplaceKeyWith, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ObjectKeyWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ObjectKey, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl GetBucketTaggingRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketTaggingRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl MaxAgeSecondsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MaxAgeSeconds, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is integer
		match location{
			None => (), // noop
			Some(loc) => {
...
impl CopySourceRangeWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CopySourceRange, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl PutBucketLifecycleConfigurationRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketLifecycleConfigurationRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for lifecycle_configuration
		if let Some(ref obj) = obj.lifecycle_configuration {
			BucketLifecycleConfigurationWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"LifecycleConfiguration".to_string());
		}
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl TopicArnWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a TopicArn, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl PutBucketTaggingRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketTaggingRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for content_md5
		if let Some(ref obj) = obj.content_md5 {
			ContentMD5Writer::write_params(request, &obj, Some(&ArgumentLocation::Header), &"Content-MD5".to_string());
		...
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
		TaggingWriter::write_params(request, &obj.tagging, Some(&ArgumentLocation::Body), &"Tagging".to_string());
	}
}
#[derive(Debug, Default)]
...
impl GetBucketLifecycleConfigurationRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketLifecycleConfigurationRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl GetBucketRequestPaymentRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketRequestPaymentRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl CommonPrefixWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CommonPrefix, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		PrefixWriter::write_params(request, &obj.prefix, Some(&ArgumentLocation::Body), &"Prefix".to_string());
	}
}
...
impl NoSuchKeyWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NoSuchKey, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
	}
}
#[derive(Debug)]
...
impl UploadPartRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a UploadPartRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for body
		if let Some(ref obj) = obj.body {
			BodyWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Body".to_string());
...
impl ObjectVersionListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ObjectVersionList, location: Option<&ArgumentLocation>, location_name: &str) {
...
struct MFAWriter;
impl MFAWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MFA, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl MultipartUploadListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MultipartUploadList, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl AllowedHeaderWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a AllowedHeader, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
struct BucketWriter;
impl BucketWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Bucket, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		CreationDateWriter::write_params(request, &obj.creation_date, Some(&ArgumentLocation::Body), &"CreationDate".to_string());
		BucketNameWriter::write_params(request, &obj.name, Some(&ArgumentLocation::Body), &"Name".to_string());
	}
}
pub type URI = String;
...
struct URIWriter;
impl URIWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a URI, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl RequestChargedWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a RequestCharged, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl PutBucketLoggingRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PutBucketLoggingRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketLoggingStatusWriter::write_params(request, &obj.bucket_logging_status, Some(&ArgumentLocation::Body), &"BucketLoggingStatus".to_string());
		// optional writing for content_md5
		if let Some(ref obj) = obj.content_md5 {
			ContentMD5Writer::write_params(request, &obj, Some(&ArgumentLocation::Header), &"Content-MD5".to_string());
		}
...
impl DelimiterWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Delimiter, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl MetadataValueWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MetadataValue, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl LifecycleConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a LifecycleConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		RulesWriter::write_params(request, &obj.rules, Some(&ArgumentLocation::Body), &"Rule".to_string());
	}
}
...
impl ExpirationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a Expiration, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl IfMatchWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a IfMatch, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ResponseExpiresWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ResponseExpires, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is timestamp
		match location{
			None => (), // noop
			Some(loc) => {
...
impl DeleteBucketTaggingRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteBucketTaggingRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl LambdaFunctionConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a LambdaFunctionConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for filter
		if let Some(ref obj) = obj.filter {
			NotificationConfigurationFilterWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Filter".to_string());
		}
		LambdaFunctionArnWriter::write_params(request, &obj.lambda_function_arn, Some(&ArgumentLocation::Body), &"CloudFunction".to_string());
		// optional writing for id
		if let Some(ref obj) = obj.id {
			NotificationIdWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"Id".to_string());
		}
...
impl EncodingTypeWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a EncodingType, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
struct IDWriter;
impl IDWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ID, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl PartNumberMarkerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a PartNumberMarker, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is integer
		match location{
			None => (), // noop
			Some(loc) => {
...
impl DeleteMarkerVersionIdWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a DeleteMarkerVersionId, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl CopySourceIfMatchWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CopySourceIfMatch, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ReplicationRuleStatusWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ReplicationRuleStatus, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ContentTypeWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ContentType, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ObjectVersionIdWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ObjectVersionId, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl S3KeyFilterWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a S3KeyFilter, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		FilterRuleListWriter::write_params(request, &obj.filter_rules, Some(&ArgumentLocation::Body), &"FilterRule".to_string());
	}
}
#[derive(Debug, Default)]
...
impl GetBucketLocationRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a GetBucketLocationRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		BucketNameWriter::write_params(request, &obj.bucket, Some(&ArgumentLocation::Uri), &"Bucket".to_string());
	}
}
...
impl NextPartNumberMarkerWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NextPartNumberMarker, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is integer
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ListPartsRequestWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ListPartsRequest, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for request_payer
		if let Some(ref obj) = obj.request_payer {
			RequestPayerWriter::write_params(request, &obj, Some(&ArgumentLocation::Header), &"x-amz-request-payer".to_string());
...
impl RequestPaymentConfigurationWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a RequestPaymentConfiguration, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		PayerWriter::write_params(request, &obj.payer, Some(&ArgumentLocation::Body), &"Payer".to_string());
	}
}
...
struct ETagWriter;
impl ETagWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ETag, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl ObjectIdentifierWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a ObjectIdentifier, location: Option<&ArgumentLocation>, location_name: &str) {
		// STRUCT_WRITER
		// optional writing for version_id
		if let Some(ref obj) = obj.version_id {
			ObjectVersionIdWriter::write_params(request, &obj, Some(&ArgumentLocation::Body), &"VersionId".to_string());
		}
		ObjectKeyWriter::write_params(request, &obj.key, Some(&ArgumentLocation::Body), &"Key".to_string());
	}
}
...
impl NotificationIdWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a NotificationId, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is string
		match location{
			None => (), // noop
			Some(loc) => {
...
impl FilterRuleListWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a FilterRuleList, location: Option<&ArgumentLocation>, location_name: &str) {
...
impl CreationDateWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a CreationDate, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is timestamp
		match location{
			None => (), // noop
			Some(loc) => {
...
impl MaxPartsWriter {
	fn write_params<'a>(request: &mut SignedRequest<'a>, obj: &'a MaxParts, location: Option<&ArgumentLocation>, location_name: &str) {
// shape_type is integer
		match location{
			None => (), // noop
			Some(loc) => {
...
impl<'a> S3Client<'a> { 
	...
	pub fn list_object_versions(&mut self, input: &ListObjectVersionsRequest) -> Result<ListObjectVersionsOutput, AWSError> {
		...
		ListObjectVersionsRequestWriter::write_params(&mut request, &input, None, &"".to_string());
	...
	pub fn put_bucket_policy(&mut self, input: &PutBucketPolicyRequest) -> Result<(), AWSError> {
		...
		PutBucketPolicyRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_bucket_lifecycle_configuration(&mut self, input: &PutBucketLifecycleConfigurationRequest) -> Result<(), AWSError> {
		...
		PutBucketLifecycleConfigurationRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn list_objects(&mut self, input: &ListObjectsRequest) -> Result<ListObjectsOutput, AWSError> {
		...
		ListObjectsRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_bucket_website(&mut self, input: &PutBucketWebsiteRequest) -> Result<(), AWSError> {
		...
		PutBucketWebsiteRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_bucket_notification(&mut self, input: &PutBucketNotificationRequest) -> Result<(), AWSError> {
		...
		PutBucketNotificationRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_bucket_logging(&mut self, input: &PutBucketLoggingRequest) -> Result<(), AWSError> {
		...
		PutBucketLoggingRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_bucket_replication(&mut self, input: &PutBucketReplicationRequest) -> Result<(), AWSError> {
		...
		PutBucketReplicationRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn upload_part(&mut self, input: &UploadPartRequest) -> Result<UploadPartOutput, AWSError> {
		...
		UploadPartRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_object(&mut self, input: &PutObjectRequest) -> Result<PutObjectOutput, AWSError> {
		...
		PutObjectRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn delete_bucket_cors(&mut self, input: &DeleteBucketCorsRequest) -> Result<(), AWSError> {
		...
		DeleteBucketCorsRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_bucket_versioning(&mut self, input: &PutBucketVersioningRequest) -> Result<(), AWSError> {
		...
		PutBucketVersioningRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_cors(&mut self, input: &GetBucketCorsRequest) -> Result<GetBucketCorsOutput, AWSError> {
		...
		GetBucketCorsRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_bucket_lifecycle(&mut self, input: &PutBucketLifecycleRequest) -> Result<(), AWSError> {
		...
		PutBucketLifecycleRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_acl(&mut self, input: &GetBucketAclRequest) -> Result<GetBucketAclOutput, AWSError> {
		...
		GetBucketAclRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_logging(&mut self, input: &GetBucketLoggingRequest) -> Result<GetBucketLoggingOutput, AWSError> {
		...
		GetBucketLoggingRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn head_bucket(&mut self, input: &HeadBucketRequest) -> Result<(), AWSError> {
		...
		HeadBucketRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_bucket_acl(&mut self, input: &PutBucketAclRequest) -> Result<(), AWSError> {
		...
		PutBucketAclRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn delete_bucket_website(&mut self, input: &DeleteBucketWebsiteRequest) -> Result<(), AWSError> {
		...
		DeleteBucketWebsiteRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn delete_bucket_policy(&mut self, input: &DeleteBucketPolicyRequest) -> Result<(), AWSError> {
		...
		DeleteBucketPolicyRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_notification_configuration(&mut self, input: &GetBucketNotificationConfigurationRequest) -> Result<NotificationConfiguration, AWSError> {
		...
		GetBucketNotificationConfigurationRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn delete_objects(&mut self, input: &DeleteObjectsRequest) -> Result<DeleteObjectsOutput, AWSError> {
		...
		DeleteObjectsRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn delete_bucket_replication(&mut self, input: &DeleteBucketReplicationRequest) -> Result<(), AWSError> {
		...
		DeleteBucketReplicationRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn copy_object(&mut self, input: &CopyObjectRequest) -> Result<CopyObjectOutput, AWSError> {
		...
		CopyObjectRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_bucket_request_payment(&mut self, input: &PutBucketRequestPaymentRequest) -> Result<(), AWSError> {
		...
		PutBucketRequestPaymentRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_bucket_notification_configuration(&mut self, input: &PutBucketNotificationConfigurationRequest) -> Result<(), AWSError> {
		...
		PutBucketNotificationConfigurationRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn head_object(&mut self, input: &HeadObjectRequest) -> Result<HeadObjectOutput, AWSError> {
		...
		HeadObjectRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn delete_bucket_tagging(&mut self, input: &DeleteBucketTaggingRequest) -> Result<(), AWSError> {
		...
		DeleteBucketTaggingRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_object_torrent(&mut self, input: &GetObjectTorrentRequest) -> Result<GetObjectTorrentOutput, AWSError> {
		...
		GetObjectTorrentRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_lifecycle(&mut self, input: &GetBucketLifecycleRequest) -> Result<GetBucketLifecycleOutput, AWSError> {
		...
		GetBucketLifecycleRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn create_bucket(&mut self, input: &CreateBucketRequest) -> Result<CreateBucketOutput, AWSError> {
		...
		CreateBucketRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn complete_multipart_upload(&mut self, input: &CompleteMultipartUploadRequest) -> Result<CompleteMultipartUploadOutput, AWSError> {
		...
		CompleteMultipartUploadRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_website(&mut self, input: &GetBucketWebsiteRequest) -> Result<GetBucketWebsiteOutput, AWSError> {
		...
		GetBucketWebsiteRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn create_multipart_upload(&mut self, input: &CreateMultipartUploadRequest) -> Result<CreateMultipartUploadOutput, AWSError> {
		...
		CreateMultipartUploadRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn delete_bucket(&mut self, input: &DeleteBucketRequest) -> Result<(), AWSError> {
		...
		DeleteBucketRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_object(&mut self, input: &GetObjectRequest) -> Result<GetObjectOutput, AWSError> {
		...
		GetObjectRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_policy(&mut self, input: &GetBucketPolicyRequest) -> Result<GetBucketPolicyOutput, AWSError> {
		...
		GetBucketPolicyRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_versioning(&mut self, input: &GetBucketVersioningRequest) -> Result<GetBucketVersioningOutput, AWSError> {
		...
		GetBucketVersioningRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn list_multipart_uploads(&mut self, input: &ListMultipartUploadsRequest) -> Result<ListMultipartUploadsOutput, AWSError> {
		...
		ListMultipartUploadsRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_lifecycle_configuration(&mut self, input: &GetBucketLifecycleConfigurationRequest) -> Result<GetBucketLifecycleConfigurationOutput, AWSError> {
		...
		GetBucketLifecycleConfigurationRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_request_payment(&mut self, input: &GetBucketRequestPaymentRequest) -> Result<GetBucketRequestPaymentOutput, AWSError> {
		...
		GetBucketRequestPaymentRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_bucket_tagging(&mut self, input: &PutBucketTaggingRequest) -> Result<(), AWSError> {
		...
		PutBucketTaggingRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_tagging(&mut self, input: &GetBucketTaggingRequest) -> Result<GetBucketTaggingOutput, AWSError> {
		...
		GetBucketTaggingRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn abort_multipart_upload(&mut self, input: &AbortMultipartUploadRequest) -> Result<AbortMultipartUploadOutput, AWSError> {
		...
		AbortMultipartUploadRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_object_acl(&mut self, input: &PutObjectAclRequest) -> Result<PutObjectAclOutput, AWSError> {
		...
		PutObjectAclRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_location(&mut self, input: &GetBucketLocationRequest) -> Result<GetBucketLocationOutput, AWSError> {
		...
		GetBucketLocationRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn put_bucket_cors(&mut self, input: &PutBucketCorsRequest) -> Result<(), AWSError> {
		...
		PutBucketCorsRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn delete_bucket_lifecycle(&mut self, input: &DeleteBucketLifecycleRequest) -> Result<(), AWSError> {
		...
		DeleteBucketLifecycleRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn list_parts(&mut self, input: &ListPartsRequest) -> Result<ListPartsOutput, AWSError> {
		...
		ListPartsRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_object_acl(&mut self, input: &GetObjectAclRequest) -> Result<GetObjectAclOutput, AWSError> {
		...
		GetObjectAclRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn upload_part_copy(&mut self, input: &UploadPartCopyRequest) -> Result<UploadPartCopyOutput, AWSError> {
		...
		UploadPartCopyRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn delete_object(&mut self, input: &DeleteObjectRequest) -> Result<DeleteObjectOutput, AWSError> {
		...
		DeleteObjectRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn restore_object(&mut self, input: &RestoreObjectRequest) -> Result<RestoreObjectOutput, AWSError> {
		...
		RestoreObjectRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
	...
	pub fn get_bucket_replication(&mut self, input: &GetBucketReplicationRequest) -> Result<GetBucketReplicationOutput, AWSError> {
		...
		GetBucketReplicationRequestWriter::write_params(&mut request, &input, None, &"".to_string());
		let mut result = request.sign_and_execute(try!(self.creds.get_credentials()));
		let status = result.status.to_u16();
